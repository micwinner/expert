    ...
    function() {
        return {
            ...
            template: "<div class=\"page-list\">" +
                ...
                "第<span>{{jumpPageNum}}</span>页 " +
                //'第<input type="text" ng-model="jumpPageNum"  ng-keyup="jumpToPage($event)"/>页 ' +
                //'每页<select ng-model="conf.itemsPerPage" clall="select" ng-options="option for option in conf.perPageOptions " ng-change="changeItemsPerPage()"></select>' +
